...
function openVaultOverlay(vaultHref){
  ...
  Object.assign(overlay.style,{position:"fixed",inset:"0",zIndex:"5000",background:"rgba(0,0,0,.55)",padding:"12px",display:"flex",flexDirection:"column"});

  const shell = document.createElement("div");
  Object.assign(shell.style,{width:"100%",height:"100%",background:"#fff",borderRadius:"14px",overflow:"hidden",display:"flex",flexDirection:"column"});
  const bar = document.createElement("div");
  Object.assign(bar.style,{display:"flex",justifyContent:"space-between",alignItems:"center",gap:"10px",padding:"10px 12px",background:"#123f46",color:"white",font:"700 16px system-ui"});
  bar.innerHTML = '<span>Unlock Secure Vault</span><button type="button" data-close-vault style="border:0;border-radius:8px;padding:8px 12px;font-weight:800;cursor:pointer">Close</button>';
  ...
  Object.assign(frame.style,{border:"0",width:"100%",flex:"1",background:"white"});
