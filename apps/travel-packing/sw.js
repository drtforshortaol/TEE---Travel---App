const CACHE = 'tee-packing-v3-5-32-enchanting-travels';
const CACHE_PREFIX = 'tee-packing-';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./enchanting-travels-packing-list.html','./manifest.json','../../traveler-help.css','../../traveler-help.js'];
