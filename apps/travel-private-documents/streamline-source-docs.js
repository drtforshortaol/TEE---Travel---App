...
(function(){
  ...
  window.TEETravelerSourceNavV3429={showOnly,showAdd,showManager,showLibrary,normalTargets};
  window.TEETravelerSourceNavV3427=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3426=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3424=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3423=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3421=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3419=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3418=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3417=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3416=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3415=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3414=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3412=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3411=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3410=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3409=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3408=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3407=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3406=window.TEETravelerSourceNavV3429;
  window.TEETravelerSourceNavV3404=window.TEETravelerSourceNavV3429;
  ...
  const handoff=document.createElement('script');handoff.src='chatgpt-handoff-v3427.js?v=3.4.29';handoff.dataset.teeChatgptHandoff='3.4.29';handoff.addEventListener('load',setBuild);document.head.appendChild(handoff);
  const localLibrary=document.createElement('script');localLibrary.src='local-source-library-v3426.js?v=3.4.29';localLibrary.dataset.teeLocalSourceLibrary='3.4.29';localLibrary.addEventListener('load',()=>setTimeout(()=>window.TEERenderLocalSourceLibraryV3426?.(),0));document.head.appendChild(localLibrary);
  const mrz=document.createElement('script');mrz.src='mrz-ocr-v3412.js?v=3.4.29';mrz.dataset.teePassportMrz='3.4.29';
  const loadUx=()=>{
    if(document.querySelector('script[data-tee-traveler-source-ux="3.4.29"]'))return;
    const ux=document.createElement('script');ux.src='traveler-source-flow-v3415.js?v=3.4.29';ux.dataset.teeTravelerSourceUx='3.4.29';
  ...
  const reviewBridge=document.createElement('script');reviewBridge.src='structured-documents-review-v3426.js?v=3.4.29';reviewBridge.dataset.teeStructuredReview='3.4.29';reviewBridge.addEventListener('load',loadUx);reviewBridge.addEventListener('error',loadUx);document.head.appendChild(reviewBridge);
