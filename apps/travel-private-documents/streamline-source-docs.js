...
(function(){
  ...
  if(!maintenanceMode && requestedView!=='vault'){
    ...
    guard.id='teeTravelerLegacyIntakeGuardV3421';
  ...
  window.TEETravelerSourceNavV3421={showOnly,showAdd,showManager,showLibrary,normalTargets};
  window.TEETravelerSourceNavV3419=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3418=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3417=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3416=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3415=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3414=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3412=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3411=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3410=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3409=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3408=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3407=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3406=window.TEETravelerSourceNavV3421;
  window.TEETravelerSourceNavV3404=window.TEETravelerSourceNavV3421;
  ...
  const mrz=document.createElement('script');mrz.src='mrz-ocr-v3412.js?v=3.4.21';mrz.dataset.teePassportMrz='3.4.21';
  const loadUx=()=>{
    if(document.querySelector('script[data-tee-traveler-source-ux="3.4.21"]'))return;
    const ux=document.createElement('script');ux.src='traveler-source-flow-v3415.js?v=3.4.21';ux.dataset.teeTravelerSourceUx='3.4.21';
