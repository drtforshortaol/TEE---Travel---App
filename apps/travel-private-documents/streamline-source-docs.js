...
(function(){
  ...
  const setBuild=()=>{if(buildLabel)buildLabel.textContent=`TEE v${BUILD}`;};
  setBuild();
  ...
  if(!maintenanceMode && requestedView!=='vault'){
    ...
    guard.id='teeTravelerLegacyIntakeGuardV3427';
  ...
  window.TEETravelerSourceNavV3427={showOnly,showAdd,showManager,showLibrary,normalTargets};
  window.TEETravelerSourceNavV3426=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3424=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3423=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3421=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3419=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3418=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3417=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3416=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3415=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3414=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3412=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3411=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3410=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3409=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3408=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3407=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3406=window.TEETravelerSourceNavV3427;
  window.TEETravelerSourceNavV3404=window.TEETravelerSourceNavV3427;
  ...
  const loadUx=()=>{
    if(document.querySelector('script[data-tee-traveler-source-ux="3.4.27"]'))return;
    const ux=document.createElement('script');ux.src='traveler-source-flow-v3415.js?v=3.4.27';ux.dataset.teeTravelerSourceUx='3.4.27';
