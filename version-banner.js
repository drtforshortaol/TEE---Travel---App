...
(function(){
  ...
  function loadShellCleaner(){loadHubScript('hub-shared-sync-shell-cleaner-v3501.js?v=3.5.05','data-tee-shared-sync-shell-cleaner','3.5.05');}
  function loadVaultIntake(){loadHubScript('hub-vault-intake-v3511.js?v=3.5.11','data-tee-vault-intake','3.5.11');}
  paint(fallback);
  loadHubCompletion();
